Write-Host "=== DipOut Frontend Auth Fix Script ===" -ForegroundColor Cyan

$frontend = "C:\Users\jdbes\Desktop\dipout\src\pages"

# --- Register.jsx ---
$registerFile = Join-Path $frontend "Register.jsx"
...
"@ | Set-Content $registerFile -Encoding UTF8

Write-Host "Updated Register.jsx" -ForegroundColor Green

# --- Login.jsx ---
$loginFile = Join-Path $frontend "Login.jsx"
...
"@ | Set-Content $loginFile -Encoding UTF8

Write-Host "Updated Login.jsx" -ForegroundColor Green

# --- AuthContext.jsx ---
$authFile = Join-Path $frontend "AuthContext.jsx"
...
"@ | Set-Content $authFile -Encoding UTF8

Write-Host "Updated AuthContext.jsx" -ForegroundColor Green

Write-Host "=== Frontend Auth Fix Complete ===" -ForegroundColor Cyan
