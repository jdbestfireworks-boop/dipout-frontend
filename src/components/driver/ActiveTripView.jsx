  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5">
        ...
        <Badge className="bg-gradient-to-r from-primary/20 to-primary/10 text-primary border-primary/30 capitalize font-semibold text-xs px-3 py-1.5 rounded-full shadow-lg">
