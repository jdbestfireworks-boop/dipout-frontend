...
import { Mail, Lock, Loader2, Car, DollarSign, Clock, Shield, ArrowLeft, CheckCircle2 } from "lucide-react";
...
export default function RegisterDriver() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left panel */}
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-gradient-to-br from-green-950/40 via-background to-background p-12 border-r border-border">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-4xl font-display font-bold leading-tight">Start earning<br />today.</h2>
            <p className="text-muted-foreground mt-3 text-lg">Join the Dip Out driver network and set your own hours.</p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {!showOtp ? (
              <motion.div key="form" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -16 }} transition={{ duration: 0.2 }}>
                ...
                <div className="mb-2">
                  <span className="text-xs font-semibold text-green-400 uppercase tracking-widest">Driver Sign Up</span>
                </div>
                <div className="mb-8">
                  <h1 className="text-3xl font-display font-bold">Create your account</h1>
                  <p className="text-muted-foreground mt-1 text-sm">Sign up to start driving with Dip Out</p>
                </div>
